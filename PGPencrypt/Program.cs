...
namespace PGPencrypt
{
    class Program
    {
        ...
        public static readonly string PublicKey = Properties.Settings.Default.PublicKey;
        ...
        private static readonly string PrivateKeyOnly = Properties.Settings.Default.PrivateKeyOnly;
